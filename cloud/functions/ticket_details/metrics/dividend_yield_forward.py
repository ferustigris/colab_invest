...
class ForwardAnnualDividendYield(FinancialMetric):
    ...
    def get_load_for_ticker(self, stock_details, yahoo_data):
        ...
        if not yahoo_data.get('forwardAnnualDividendYield'):
            print(f"forwardAnnualDividendYield data not available for {stock_details.ticker}")
        ...
        self.value = yahoo_data['forwardAnnualDividendYield'] / 100  # Already percentage
